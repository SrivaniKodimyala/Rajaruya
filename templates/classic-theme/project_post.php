...
<div id="titlebar" class="dark-modeforgray">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="dark-modetextgray"><?php _e("Post Project") ?></h2>
                <!-- Breadcrumbs -->
            ...
            <div class="col-xl-8 col-md-12">
                ...
                <form id="post_job_form" action="<?php url("POST-PROJECT") ?>?action=post_job" method="post"
                    ...
                    <div class="dashboard-box margin-top-0">
                        ...
                        <h5><?php _e("Name of contact person") ?> *</h5>
                        <input type="text" class="with-border" name="contact_person_name" required>
                    </div>
                    <div class="submit-field">
                        <h5><?php _e("Designation of contact person") ?> *</h5>
                        <input type="text" class="with-border" name="contact_person_designation" required>
                    </div>
                    <div class="submit-field">
                        <h5><?php _e("Name of the Company") ?> *</h5>
                        <input type="text" class="with-border" name="company_name" required>
                    </div>
                    <div class="submit-field">
                        <h5><?php _e("Client") ?> *</h5>
                        <input type="text" class="with-border" name="client" required>
                    </div>
                            ...
                            <div class="payment">
                                ...
                                <div class="payment-tab payment-tab-active">
                                    ...
                                    <div class="payment-tab-content">
                                        <p><?php _e("design and drawings submitted in soft copy - online support for approval.") ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="payment-tab">
                                    <div class="payment-tab-trigger">
                                        <input id="professional" name="make_premium" type="radio" value="1">
                                        <label for="professional"><?php _e("Professional") ?> <?php _e("Project") ?></label>
                                    </div>
                                    <div class="payment-tab-content">
                                        <p><?php _e("design and drawings submitted in soft copy and one set of hard copy- online support for approval.") ?></p>
                                    </div>
                                </div>

                                <div class="payment-tab">
                                    <div class="payment-tab-trigger">
                                        <input id="premium" name="make_premium" type="radio" value="2">
                                        <label for="premium"><?php _e("Premium") ?> <?php _e("Project") ?></label>
                                    </div>
                                    <div class="payment-tab-content">
                                        <p><?php _e("Design and drawings submitted in soft copy and required number of hard copies- online & inperson support for approval.") ?></p>
                                    </div>
                                </div>
