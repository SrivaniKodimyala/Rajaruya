    ...
    <div class="dashboard-content-container dark-modeforgray" data-simplebar>
        <div class="dashboard-content-inner" >
            ...
            <div class="dashboard-headline">
                <h3 class="dark-modetextgray"><?php _e("Hidden Jobs") ?></h3>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs" class="dark">
                    <ul>
                        <li><a href="<?php url("INDEX") ?>"><?php _e("Home") ?></a></li>
                        <li><?php _e("Hidden Jobs") ?></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box">
                        <div class="headline">
                            <h3><i class="icon-feather-eye-off"></i> <?php _e("Hidden Jobs") ?></h3>
                        </div>
                        <!-- Content Start -->
                        <div class="content">
                            <div class="content with-padding">
                                <div class="table-responsive">
                                    <table id="js-table-list" class="basic-table dashboard-box-list">
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-center"><?php _e("No hidden jobs found.") ?></td>
                                        </tr>
                                        <?php }  ?>
                                    </table>
                                </div>
