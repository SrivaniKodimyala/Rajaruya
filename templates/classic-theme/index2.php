        ...
        <div class="row">
            <div class="col-md-12">
                <div class="banner-headline">
                    <h3><strong><?php _e("Find Jobs, Hire Creatives") ?></strong>
                        <br>
...
<!-- Category Boxes -->
<div class="section padding-top-65 padding-bottom-45 dark-modeforgray">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <?php foreach($category as $cat){ ?>
                        <a href="<?php echo $cat['link']; ?>" class="category-box">
                            ...
                            <div class="category-box-content">
                                ...
                                ><?php echo $cat['name']; ?> <small>(<?php echo $cat['main_ads_count']; ?>)</small></h3>
                            </div>
...
<!-- Features Jobs -->
<div class="section gray padding-top-65 padding-bottom-65 dark-modeforgray">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="section-headline margin-top-0 margin-bottom-35">
                    <h3 class="dark-modetextgray"><?php _e("Featured Jobs") ?></h3>
