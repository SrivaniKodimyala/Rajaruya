...
<!-- Titlebar
================================================== -->
<div class="single-page-header freelancer-header dark-modeforgray" data-background-image="<?php _esc(TEMPLATE_URL);?>/images/single-freelancer.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-8 content-right-offset">
            ...
            <div class="single-page-section">
                <h3 class="margin-bottom-25 dark-modetextgray"><?php _e("About Me") ?></h3>
                <?php _esc($about);?>
            </div>
            ...
            <div class="sidebar-container">
                <?php if($profile_usertype == "user"){ ?>
                    ...
                    <div class="profile-overview">
                        <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($hourly_rate)?></strong><span><?php _e("Hourly Rate") ?></span></div>
                        <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($win_project)?></strong><span><?php _e("Won Bid") ?></span></div>
                        <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($rehired)?></strong><span><?php _e("Rehired") ?></span></div>
                    </div>
                    ...
                    <div class="sidebar-widget">
                        <div class="freelancer-indicators">
                            ...
                            <!-- Indicator -->
                            <div class="indicator">
                                <strong class="dark-modetextgray"><?php _esc($project_completed)?>%</strong>
                            ...
                            <!-- Indicator -->
                            <div class="indicator">
                                <strong class="dark-modetextgray"><?php _esc($recommendation_percentage)?>%</strong>
                            ...
                            <!-- Indicator -->
                            <div class="indicator">
                                <strong class="dark-modetextgray"><?php _esc($on_budget_percentage)?>%</strong>
                            ...
                            <!-- Indicator -->
                            <div class="indicator">
                                <strong class="dark-modetextgray"><?php _esc($on_time_percentage)?>%</strong>
                ...
                <?php }else{ ?>
                    <div class="sidebar-widget">
                        <div class="profile-overview">
                            <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($open_projects)?></strong><span><?php _e("Open Projects")?></span></div>
                            <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($completed_projects)?></strong><span><?php _e("Completed Projects")?></span></div>
                        </div>
                        <div class="profile-overview">
                            <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($total_projects)?></strong><span><?php _e("Total Projects")?></span></div>
                            <div class="overview-item"><strong class="dark-modetextgray"><?php _esc($posted_jobs)?></strong><span><?php _e("Active Jobs")?></span></div>
                        </div>
                    </div>
                <?php } ?>
...
if($is_login) {
    if ($config['quickchat_socket_on_off'] == 'on' || $config['quickchat_ajax_on_off'] == 'on') {
        ...
        echo '<a href="' . _esc($quickchat_url, false) . '" 
                ...
                <!-- Widget -->
                <div class="sidebar-widget">
                    <h3 class="dark-modetextgray"><?php _e("Social Profiles") ?></h3>
                ...
                <!-- Sidebar Widget -->
                <div class="sidebar-widget">
                    <h3 class="dark-modetextgray"><?php _e("Bookmark share") ?></h3>

                    <?php if($usertype == 'employer'){ ?>
                        <!-- Bookmark Button -->
                        <button class="bookmark-button fav-button margin-bottom-25 set-user-fav <?php if($user_favorite == '1'){ echo 'added'; } ?>" data-favuser-id="<?php _esc($userid)?>" data-userid="<?php _esc($user_id)?>" data-action="setFavUser">
