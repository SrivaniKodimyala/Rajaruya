...
<div id="footer">
                    ...
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php url("TERMSANDCONDITIONS") ?>"><?php _e("Terms & Conditions") ?></a></li>
                             <li><a href="<?php url("PRIVACYPOLICY") ?>"><?php _e("Privacy Policy") ?></a></li>
                              <li><a href="<?php url("REFUNDPOLICY") ?>"><?php _e("Refund Policy") ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    © <?php echo date("Y"); ?> <a href="<?php url("INDEX") ?>" style="color: #20C997;">Rajasuya Engineering Solutions LLP.</a> All Rights Reserved  &nbsp; || &nbsp; Developed by <a href="https://ultrakeyit.com/" target="_blank" style="color: #20C997;">Ultrakey IT Solutions Pvt. Ltd.</a>
</div>
