                    ...
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php url("ADVERTISE_HERE") ?>"><?php _e("Advertise Here") ?></a></li>
                               <li><a href="<?php url("TERMSANDCONDITIONS") ?>"><?php _e("Terms & Conditions") ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
QuickBanner Manager
============================== -->
<link href="<?php _esc($config['site_url']);?>plugins/banner-admanager/css/ubm.css?ver=2.50" rel="stylesheet">
<script src="<?php _esc($config['site_url']);?>plugins/banner-admanager/js/ubm-jsonp.js?ver=2.50"></script>
<!-- ====================
QuickBanner Manager
============================== -->
<!-- Scripts
