...
<div id="titlebar" class="margin-bottom-0 dark-modeforgray">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="dark-modetextgray"><?php _e("Post a Job") ?></h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
...
<div class="section gray dark-modeforgray">
    <div class="container">
        <div class="row">
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <select id="company-select" class="selectpicker with-border"
                                            ...
                                            <?php foreach ($companies as $company){ ?>
                                                <option value="<?php _esc($company['id'])?>"><?php _esc($company['title'])?></option>
                                            <?php } ?>
                                            ...
                                            <div class="col-xl-6 col-md-12">
                                                <div class="checkbox margin-top-12">
                                                    ...
                                                    <label for="phone"><span
                                                                class="checkbox-icon"></span> <?php _e("Hide from users") ?>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
