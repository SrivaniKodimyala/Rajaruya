<?php
overall_header(__("Pending Jobs"));
?>
    <!-- Dashboard Container -->
...
<?php include_once TEMPLATE_PATH.'/dashboard_sidebar.php'; ?>
    ...
    <div class="dashboard-headline">
        <h3 class="dark-modetextgray"><?php _e("Pending Jobs") ?></h3>
        <!-- Breadcrumbs -->
        <nav id="breadcrumbs" class="dark">
            <ul>
                <li><a href="<?php url("INDEX") ?>"><?php _e("Home") ?></a></li>
                <li><?php _e("Pending Jobs") ?></li>
            </ul>
        </nav>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="dashboard-box">
                <div class="headline">
                    <h3><i class="icon-feather-clock"></i> <?php _e("Pending Jobs") ?></h3>
                </div>
                <!-- Content Start -->
                <div class="content">
                        ...
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                if($totalitem){
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center"><?php _e("No pending jobs found.") ?></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
