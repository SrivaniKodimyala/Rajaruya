...
<form method="get" action="<?php url("SEARCH_PROJECTS") ?>" name="locationForm" id="ListingForm" class="dark-modeforgray">
    <div id="titlebar dark-modeforgray" style="margin-top:30px">
        <div class="container dark-modeforgray">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="dark-modetextgray"><?php _e("We found") ?> <?php _esc($adsfound) ?> <?php _e("Projects") ?></h2>
                    <!-- Breadcrumbs -->
                    <nav id="breadcrumbs" class="listing_job">
                        <ul>
                            <li><a class="dark-modetextgray" href="<?php url("INDEX") ?>"><?php _e("Home") ?></a></li>
                            <?php
                            if($maincategory != ""){
                                echo '<li class="dark-modetextgray">'._esc($maincategory,false).'</li>';
                            }
                            if($subcategory != ""){
                                echo '<li class="dark-modetextgray">'._esc($subcategory,false).'</li>';
                            }
                            if($maincategory == "" && $subcategory == ""){
                                echo '<li class="dark-modetextgray">'.__("All Categories").'</li>';
                            }
                            ?>
                        </ul>
                    </nav>
    ...
    <div class="container dark-modeforgray">
        <div class="row">
            <div class="col-xl-3 col-lg-4">
                ...
                <div class="sidebar-container search-sidebar">
                    <div class="sidebar-widget">
                        <h3 class="dark-modetextgray"><?php _e("Project Type") ?></h3>
                        <ul>
                            <li>
                                <div class="radio">
            ...
            <div class="col-xl-9 col-lg-8 content-left-offset">
                ...
                <h3 class="page-title dark-modetextgray"><?php _e("Search Results") ?></h3>
                            ...
                            <nav class="pagination">
                                <ul>
                                    ...
                                    foreach($pages as $page) {
                                        if ($page['current'] == 0){
                                            ?>
                                            <li><a class="dark-modetextwhite" href="<?php _esc($page['link'])?>"><?php _esc($page['title'])?></a></li>
                                        <?php }else{
                                            ?>
