...
<div class="container">
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4">
            ...
            <span><?php _e("Name of Contact Person") ?></span>
            <h5><?php _esc($contact_person_name)?></h5>
        </li>
        <li>
            <i class="fa fa-id-badge"></i>
            <span><?php _e("Designation of Contact Person") ?></span>
            <h5><?php _esc($contact_person_designation)?></h5>
        </li>
        <li>
            <i class="icon-material-outline-business"></i>
            <span><?php _e("Name of the Company") ?></span>
            <h5><?php _esc($company_name)?></h5>
        </li>
        <li>
            <i class="icon-material-outline-supervisor-account"></i>
            <span><?php _e("Client") ?></span>
            <h5><?php _esc($client_name)?></h5>
        </li>
                                <li>
                                    <i class="icon-material-outline-location-on"></i>
