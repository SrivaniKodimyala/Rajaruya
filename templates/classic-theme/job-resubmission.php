<?php
overall_header(__("Resubmitted Jobs"));
?>
<!-- Dashboard Container -->
    ...
    <div class="dashboard-content-container dark-modeforgray" data-simplebar>
        <div class="dashboard-content-inner" >
            ...
            <div class="dashboard-headline">
                <h3 class="dark-modetextgray"><?php _e("Resubmitted Jobs") ?></h3>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs" class="dark">
                    <ul>
                        <li><a href="<?php url("INDEX") ?>"><?php _e("Home") ?></a></li>
                        <li><?php _e("Resubmitted Jobs") ?></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box">
                        <div class="headline">
                            <h3><i class="icon-feather-rotate-cw"></i> <?php _e("Resubmitted Jobs") ?></h3>
                        </div>
                        <!-- Content Start -->
                        <div class="content">
                                    ...
                                    <table id="js-table-list" class="basic-table dashboard-box-list">
                                        ...
                                        if($totalitem){
                                            foreach ($items as $item){
                                                ?>
                                            <tr class="ajax-item-listing" data-item-id="<?php _esc($item['product_id'])?>">
                                                <td>
                                                ...
                                                <td>
                                                    <span class="dashboard-status-button blue"><?php _e("Resubmitted") ?></span>
                                                </td>
                                                <td>
                                                    <a href="#" data-ajax-action="deleteResumitAd" class="button gray ripple-effect ico item-js-delete" data-tippy-placement="top" title="<?php _e("Delete") ?>"><i class="icon-feather-trash-2"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        }else{ ?>
                                        <tr>
                                            <td colspan="3" class="text-center"><?php _e("No resubmission jobs found.") ?></td>
                                        </tr>
                                         <?php } ?>
                                    </table>
                                </div>
