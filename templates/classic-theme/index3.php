...
<div class="intro-banner <?php _esc($config['banner_overlay']);?>" data-background-image="<?php _esc($config['site_url']);?>storage/banner/<?php _esc($config['home_banner']);?>">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="banner-headline">
                    <h3>
                        <strong><?php _e("Find the perfect freelance services for your business") ?></strong>
                        <br>
                        <span><?php _e("A whole world of freelance talent at your fingertips") ?></span>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form autocomplete="off" method="get" action="<?php url("SEARCH_SERVICES") ?>" accept-charset="UTF-8">
...
<!-- How it works Boxes -->
<div class="section padding-top-65 padding-bottom-65 dark-modeforgray">
    <div class="container">
        <div class="row">
...
<?php if($config['show_latest_jobs_home']){ ?>
    <!-- Latest Jobs -->
    <div class="section padding-top-65 padding-bottom-75 dark-modeforgray">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section-headline margin-top-0 margin-bottom-35">
                        <h3 class="dark-modetextgray"
                        ><?php _e("Latest Jobs") ?></h3>
...
<div class="section gray padding-top-65 padding-bottom-70 full-width-carousel-fix dark-modeforgray">
    <div class="container">
        <div class="row">
...
<!-- Membership Plans -->
<div class="section padding-top-60 padding-bottom-75 dark-modeforgray">
    <div class="container">
        <div class="row">
...
<div class="section gray padding-top-65 padding-bottom-55 dark-modeforgray
">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <!-- Section Headline -->
                <div class="section-headline centered margin-top-0 margin-bottom-5">
                    <h3 class="dark-modetextgray"><?php _e("Testimonials") ?></h3>
                </div>
            </div>
        </div>
    </div>
...
<!-- Counters -->
<div class="section padding-top-70 padding-bottom-75 dark-modeforgray
">
    <div class="container">
        <div class="row">
...
<div class="section gray padding-top-65 padding-bottom-50 dark-modeforgray
">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<div class="section border-top padding-top-45 padding-bottom-45 dark-modeforgray">
    <!-- Logo Carousel -->
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
