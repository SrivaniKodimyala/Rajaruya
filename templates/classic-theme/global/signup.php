            ...
            <div class="login-register-page">
                ...
                <form method="post" id="register-account-form" action="#" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="account-type">
                        <div>
                            <input type="radio" name="user-type" id="freelancer-radio" class="account-type-radio" value="1" checked required/>
                            <label for="freelancer-radio" class="ripple-effect-dark"><i class="la la-user"></i> <?php _e("Freelancer") ?></label>
                        </div>
                        <div>
                            <input type="radio" name="user-type" id="employer-radio" class="account-type-radio" value="2" required/>
                    ...
                    <div class="row">
                        <!-- Full Name -->
                        <div class="form-group col-md-4 freelancer-fields">
                            <span class="form-label required"><?php _e("Full Name") ?></span>
                            <div class="input-with-icon-left">
                                <i class="la la-user"></i>
                                <input type="text" class="input-text with-border" placeholder="<?php _e("Full Name") ?>" value="<?php _esc($name_field)?>" id="name" name="name" onBlur="checkAvailabilityName()"/>
                            </div>
                            <span id="name-availability-status"><?php if($name_error != ""){ _esc($name_error) ; }?></span>
                        </div>

                        <div class="form-group col-md-4 employer-fields" style="display: none;">
                    ...
                    <div class="form-group col-md-4 employer-fields" style="display: none;">
                        ...
                        <div class="form-group col-md-8 employer-fields" style="display: none;">
        ...
        <textarea class="input-text with-border" placeholder="<?php _e("Tell us about your company") ?>" id="about_company" name="about_company"><?php _esc($about_company_field) ?></textarea>
                ...
                <label for="pan_card" class="custom-file-label">
                    <i class="fa fa-upload"></i> Choose file
                        ...
                        <!-- ID Proof -->
                        <div class="form-group col-md-4 freelancer-fields">
                            <span class="form-label required"><?php _e("ID Proof") ?></span>
                        
                               
                                <input type="file" class="custom-file-input" name="id_proof" onBlur="checkAvailabilityIdProof()" id="id_proof"/>
                <label for="id_proof" class="custom-file-label">
                    <i class="fa fa-upload"></i> Choose file
                </label>

                        <span id="id_proof-availability-status"><?php if($$id_proof_error != ""){ _esc($$id_proof_error) ; }?></span>
                    </div>
                ...
                <label for="gst_certificate" class="custom-file-label">
                    ...
                    <div class="row">
                        ...
                        <!-- Qualifications -->
                        <div class="form-group col-md-4 freelancer-fields">
                            <span class="form-label required"><?php _e("Qualifications") ?></span>
                      
                              

                            <input type="file" class="custom-file-input" name="qualifications" onBlur="checkAvailabilityQualifications()" id="qualifications"/>
                <label for="qualifications" class="custom-file-label">
                    <i class="fa fa-upload"></i> Choose file
                </label>
                 
                        <span id="qualifications-availability-status"><?php if($qualifications_error != ""){ _esc($qualifications_error) ; }?></span>
                    </div>

                    <div class="form-group col-md-4 freelancer-fields">
                        <span class="form-label required"><?php _e("Experience Certificates") ?></span>
                       

                        <input type="file" class="custom-file-input" name="experience_certificates" onBlur="checkAvailabilityExpr()" id="experience_certificates"/>
                <label for="experience_certificates" class="custom-file-label">
                    <i class="fa fa-upload"></i> Choose file
                </label>
                        <span id="experience_certificates-availability-status"><?php if($experience_certificates_error != ""){ _esc($experience_certificates_error) ; }?></span>
                    </div>
                    </div>
