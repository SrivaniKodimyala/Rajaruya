    ...
    <div class="chat-avatar">
        <div class="avatar icon-user-default" style="height: 40px; width: 40px;">
            <div class="avatar-body userimage">
                <img src="<?php _esc($config['site_url'])?>storage/profile/<?php _esc($userimg)?>"
    ...
    <div class="chat-body">
        <div class="chat-main">
            <h2 class="chat-title" dir="auto">
                <span class="wchatellips personName"><?php _esc($username)?></span>
            </h2>
        </div>
    </div>
    <div class="back-icon">
         <a style="cursor:pointer" href="<?php url("DASHBOARD") ?>"> <i class="fas fa-arrow-left"></i>  </a>
    </div>
</header>
