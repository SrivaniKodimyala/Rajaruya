                        ...
                        <div class="content with-padding">
                            <div class="table-responsive">
                                <table id="js-table-list" class="basic-table dashboard-box-list">
                                    ...
                                    <tr>
                                        <td align="right" colspan="7"><button type="button" class="button" onClick="window.location.href='<?php url("MEMBERSHIPPLANNEW") ?>/changeplan'"><?php _e("Change Plan") ?></button></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
