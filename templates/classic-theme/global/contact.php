...
">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="dark-modetextgray"><?php _e("Contact Us") ?></h2>
                <!-- Breadcrumbs -->
...
<div class="container margin-bottom-50 dark-modeforgray">
    ...
    <div class="business-info">
        <div class="row">
            <div class="col-sm-8">
                <div class="contactUs">
                    <h2 class="margin-bottom-30 dark-modetextgray"><?php _e("Contact Us") ?></h2>
                    ...
                    <div class="content with-padding">
                        <ul>
                            ...
                            if($email != ''){
                                ...
                                // Adding WhatsApp link
                                echo '<li class="job-property margin-bottom-10"><i class="fab fa-whatsapp"></i>
                                        <a href="https://wa.me/'._esc($phone,false).'" rel="nofollow">'._esc($phone,false).'</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
