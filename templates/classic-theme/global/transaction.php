...
<div id="titlebar" class="dark-modeforgray">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="dark-modetextgray"><?php _e("Transactions") ?></h2>
                <!-- Breadcrumbs -->
...
<div class="container">
    <h3 class="page-title margin-bottom-30 dark-modetextgray"><?php _e("Transactions") ?></h3>
    <table id="datatable">
        <thead>
        <tr>
            <th class="small-width dark-modetextgray"></th>
            <th class="dark-modetextgray"
            ><?php _e("Title") ?></th>
            <th class="small-width dark-modetextgray"><?php _e("Amount") ?></th>
            <th class="small-width dark-modetextgray"><?php _e("Premium") ?></th>
            <th class="dark-modetextgray"
            ><?php _e("Payment Method") ?></th>
            <th class="dark-modetextgray"
            > <?php _e("Date") ?></th>
            <th class="small-width dark-modetextgray"><?php _e("Status") ?></th>
