            ...
            <div class="app-layout-drawer-scroll">
                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            <a href="#"><i class="ion-ios-people"></i> Users</a>

                            <ul class="nav nav-subnav">
                            <li><a href="<?php echo ADMINURL; ?>global/freelancers.php">Freelancer</a></li>
                            <li><a href="<?php echo ADMINURL; ?>global/employers.php">Employer</a></li>
                                <li><a href="<?php echo ADMINURL; ?>global/users.php">All Users</a></li>
                ...
                <!-- End drawer navigation -->
                 ...
                 <div class="drawer-footer">
                    <p class="copyright"><a href="https://ultrakeyit.com" target="_blank">Rajasuya By UltrakeyIt</a> &copy;</p>
