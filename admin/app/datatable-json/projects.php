...
$sql = "SELECT p.id,p.product_name,p.package,p.created_at,p.status,p.featured,p.urgent,p.highlight, cat.cat_name as catname, u.username as username
...
{    $package = $row['package'];
    ...
    $rowpackage = '<td class="hidden-xs">'.$package.'</td>';
