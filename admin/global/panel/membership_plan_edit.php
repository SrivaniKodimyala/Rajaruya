                ...
                <div class="white-box">
                    ...
                    <form name="form2"  class="form" method="post" data-ajax-action="editMembershipPlan" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <hr>
                            <!--<div class="row form-group">-->
                            <!--    <label class="col-sm-4 control-label">Service Seller Commission Percentage</label>-->
                            <!--    <div class="col-sm-6">-->
                            <!--        <input name="service_seller_commission" type="number" class="form-control" value="<?php echo $settings['service_seller_commission'];?>">-->
                            <!--        <p class="help-block">This is a percentage that is deducted from a Freelancer account when a service is completed. The percentage is calculated from the order price.</p>-->
                            <!--    </div>-->
                            <!--</div>-->
                            <div class="row form-group">
