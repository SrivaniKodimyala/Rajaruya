                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="paymentEdit" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            if($folder == "stripe"){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <small>Leave empty if the version 2019-12-03 is not available.</small>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            if($folder == "phonepe"){
                                ?>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">PhonePe API Key:</label>
                                    <div class="col-sm-6">
                                        <input name="phonepe_api_key" type="text" class="form-control" placeholder="Enter your Phonepe API Key" value="<?php echo get_option('phonepe_api_key')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">PhonePe Secret Key:</label>
                                    <div class="col-sm-6">
                                        <input name="phonepe_secret_key" type="text" class="form-control" placeholder="Enter your Phonepe Secret Key" value="<?php echo get_option('phonepe_secret_key')?>">
                                    </div>
                                </div>
                            ...
                            if($folder == "yoomoney"){
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">PhonePe API Key:</label>
                                    <div class="col-sm-6">
                                        <input name="yoomoney_shop_id" type="text" class="form-control" placeholder="Enter your YooMoney Shop Id" value="<?php echo get_option('yoomoney_shop_id')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">PhonePe Secret Key:</label>
                                    <div class="col-sm-6">
                                        <input name="yoomoney_secret_key" type="text" class="form-control" placeholder="Enter your YooMoney Secret Key" value="<?php echo get_option('yoomoney_secret_key')?>">
                                    </div>
                                </div>
