...
function check_usernamecontact_exists($contact){
...
function check_companyname_exists($companyName){
...
function check_gstnumber_exists($gstNumber){
...
function get_user_data($username=null, $userid=null){
    ...
    if (isset($info['id'])) {
        ...
        $userinfo['id']         = $info['id'];
        $userinfo['membershipplan_id']   = $info['membershipplan_id'];
