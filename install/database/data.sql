...
--
INSERT INTO `<<prefix>>adsense` (`id`, `slug`, `size`, `provider_name`, `large_track_code`, `tablet_track_code`, `phone_track_code`, `status`) VALUES
(1, 'header_top', '728x90', 'Google AdSense', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(2, 'header_bottom', '728x90', 'Google AdSense', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '0'),
(3, 'footer_top', '728x90', 'Google AdSense', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(4, 'home_page_below_search_section', '728x90', 'Google AdSense', ' <a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(5, 'home_page_below_category_section', '728x90', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(6, 'home_page_below_featured_section', '728x90', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(7, 'home_page_below_latest_section', '728x90', 'Banner Ad', ' <a class=\"quick-bm-banner\" data-id=\"1\"></a>\n', '', '', '1'),
(8, 'home_page_below_search_section', '728x90', 'Banner Ad', ' <a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(9, 'home_page_left_sidebar', '120x600', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(10, 'home_page_right_sidebar', '120x600', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(11, 'search_page_sidebar', '125x125', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a><a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(12, 'search_page_below_category', '728x90', 'Banner Ad', ' <a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(13, 'search_page_between_list_view', '728x90', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(14, 'search_page_between_grid_view', '300x250', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(17, 'detail_page_above_similar_section', '728x90', 'Banner Ad', ' <a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(18, 'detail_page_sidebar', '125x125', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>\n<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(19, 'profile_page_below_user_section', '728x90', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(20, 'profile_page_left_sidebar', '120x600', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(21, 'profile_page_right_sidebar', '120x600', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(22, 'post_page_sidebar', '300x250', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>\n<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(23, 'inner_page_sidebar', '125x125', 'Banner Ad', '<a class=\"quick-bm-banner\" data-id=\"1\"></a>', '', '', '1'),
(24, 'inner_page_horizontal_banner', '728x90', 'Banner Ad', ' <a class=\"quick-bm-banner\" data-id=\"1\"></a>\n', '', '', '1');
...
--
INSERT INTO `<<prefix>>catagory_main` (`cat_id`, `cat_order`, `post_type`, `cat_name`, `slug`, `icon`, `picture`) VALUES
...
INSERT INTO `<<prefix>>catagory_sub` (`sub_cat_id`, `main_cat_id`, `post_type`, `sub_cat_name`, `slug`, `cat_order`, `photo_show`, `price_show`, `picture`) VALUES
...
(2, 'fr', 'ltr', 'Français', 'french', 1, 0),
(3, 'sv', 'ltr', 'svenska', 'swedish', 1, 0),
(4, 'it', 'ltr', 'Italiano', 'italian', 1, 0),
(5, 'de', 'ltr', 'Deutsch', 'german', 1, 0),
(6, 'es', 'ltr', 'Español', 'spanish', 1, 0),
(7, 'pl', 'ltr', 'Polski', 'polish', 1, 0),
(8, 'ja', 'ltr', '日本語', 'japanese', 1, 0),
(9, 'zh', 'ltr', '中国人', 'chinese', 1, 0),
(10, 'ar', 'rtl', 'العربية', 'arabic', 1, 0),
(11, 'he', 'rtl', 'עִברִית', 'hebrew', 1, 0),
(12, 'ru', 'ltr', 'Русский', 'russian', 1, 0),
(13, 'bn', 'ltr', 'বাঙালি', 'bangali', 1, 0),
(14, 'hi', 'ltr', 'हिंदी', 'hindi', 1, 0),
(15, 'bg', 'ltr', 'български', 'bulgarian', 1, 0),
(16, 'ro', 'ltr', 'Română', 'romanian', 1, 0),
(17, 'th', 'ltr', 'ไทย', 'thai', 1, 0),
(18, 'tr', 'ltr', 'Türkçe', 'turkish', 1, 0),
(19, 'ur', 'rtl', 'اردو', 'urdu', 1, 0),
(20, 'vi', 'ltr', 'Tiếng Việt', 'vietnamese', 1, 0),
(21, 'hu', 'ltr', 'Magyar', 'hungarian', 1, 0),
(22, 'pt', 'ltr', 'Português', 'portuguese', 1, 0);
...
('site_logo', 'classic-theme_logo.png'),
('site_title', 'Quick Freelance'),
('meta_keywords', 'Freelance marketplace script'),
('meta_description', 'Quicklancer Premium freelance marketplace php script. The No.1 freelance marketplace script. Premium Support.'),
...
('theme_color', '#00bd62'),
('home_banner', 'bg.jpg'),
('contact_address', '142, sodales mattis'),
...
('youtube_link', 'https://www.youtube.com/user/ABylancer'),
('facebook_app_id', ''),
('facebook_app_secret', ''),
('google_app_id', ''),
('google_app_secret', ''),
...
('validation_time', '0'),
('cron_exec_time', '300'),
('cron_time', '1659086291'),
('external_code', ''),
('site_logo_footer', 'classic-theme_footer_logo.png'),
('post_without_login', '1'),
('termcondition_link', '#'),
('privacy_link', '#'),
('blog_enable', '1'),
('blog_banner', '1'),
...
('map_type', 'openstreet'),
('quickchat_socket_on_off', 'off'),
('quickchat_socket_secret_file', ''),
('quickchat_socket_purchase_code', ''),
('quickchat_ajax_on_off', 'on'),
('quickchat_ajax_secret_file', 'quickchat'),
('quickchat_ajax_purchase_code', '123456'),
...
('header_sticky', 'unsticky'),
('transparent_header', 'transparent-header'),
('banner_overlay', 'dark-overlay'),
('reg_no_enable', '1'),
('show_membershipplan_home', '1'),
('free_membership_plan', '{\"id\":\"free\",\"name\":\"Free\",\"badge\":\"\",\"settings\":{\"service_seller_commission\":10,\"employer_commission\":10,\"freelancer_commission\":10,\"bids\":5,\"skills\":5,\"ad_limit\":999,\"ad_duration\":30,\"featured_project_fee\":10,\"featured_duration\":30,\"urgent_project_fee\":10,\"urgent_duration\":30,\"highlight_project_fee\":10,\"highlight_duration\":30,\"top_search_result\":\"no\",\"show_on_home\":\"no\",\"show_in_home_search\":\"no\",\"custom\":[]},\"status\":1}'),
('trial_membership_plan', '{\"id\":\"trial\",\"name\":\"Trial\",\"badge\":\"\",\"days\":7,\"settings\":{\"service_seller_commission\":10,\"employer_commission\":10,\"freelancer_commission\":10,\"bids\":10,\"skills\":10,\"ad_limit\":5,\"ad_duration\":30,\"featured_project_fee\":10,\"featured_duration\":30,\"urgent_project_fee\":10,\"urgent_duration\":30,\"highlight_project_fee\":10,\"highlight_duration\":30,\"top_search_result\":\"yes\",\"show_on_home\":\"yes\",\"show_in_home_search\":\"yes\",\"custom\":[]},\"status\":1}'),
('payment_minimum_deposit', '50'),
('payment_minimum_withdraw', '50'),
('invoice_nr_prefix', 'INV-'),
('invoice_admin_name', 'lorem ipsum'),
('invoice_admin_email', 'dlorem.ipsum@gmail.com'),
('invoice_admin_phone', '+91111312347'),
('invoice_admin_address', 'xxx, lorem ipsum'),
('invoice_admin_city', 'lorem'),
('invoice_admin_state', 'ipsum'),
('invoice_admin_zipcode', '31241'),
('invoice_admin_country', 'US'),
('invoice_admin_tax_type', 'Tax ID'),
('invoice_admin_tax_id', '123'),
('invoice_admin_custom_name_1', 'Custom-1'),
('invoice_admin_custom_value_1', 'value 1'),
('invoice_admin_custom_name_2', 'Custom-12'),
('invoice_admin_custom_value_2', 'value 2'),
('email_sub_signup_details', '{SITE_TITLE} - Thanks for signing up'),
('email_sub_signup_confirm', '{SITE_TITLE} - Email Confirmation'),
('email_sub_forgot_pass', '{SITE_TITLE} - Forgot Password'),
('email_sub_contact', 'Website Email: - {CONTACT_SUBJECT}'),
('email_sub_feedback', '{SITE_TITLE} - {FEEDBACK_SUBJECT}'),
('email_sub_report', '{SITE_TITLE} - Report Violation'),
...
('email_sub_contact_seller', '{SITE_TITLE} - {NAME} wants to contact you'),
('email_sub_post_notification', '{SITE_TITLE} - Job notification'),
('email_sub_freelancer_project_awarded', '{SITE_TITLE} - Project awarded to you'),
('email_sub_freelancer_project_revoke', 'Project award revoked'),
('email_sub_employer_project_accepted', '{SITE_TITLE} - Project Accepted By Freelancer'),
('email_sub_employer_project_approval_reject', '{SITE_TITLE} - Project Approval Rejected By Freelancer'),
('email_sub_milestone_created', '{SITE_TITLE} - A milestone created'),
('email_sub_milestone_released', '{SITE_TITLE} - A milestone released'),
('email_sub_milestone_request_to_release', '{SITE_TITLE} - You got a milestone release request'),
...
('email_sub_amount_deposit', '{SITE_TITLE} - Amount deposited'),
('email_sub_got_rating', 'A new rating has been received for {PROJECT_TITLE}'),
('email_message_signup_details', '<p>Dear Valued Thanks for creating an account {SITE_TITLE} ,</p><p>Your username: {USERNAME}</p><p>Your password: {PASSWORD}</p><p>Have further questions? You can start chat with live support team.</p><p>Sincerely,</p><p>{SITE_TITLE} Team!</p><p><br /></p>'),
('email_message_signup_confirm', '<p>Greetings from {SITE_TITLE} Team!</p><p>Thanks for registering with {SITE_TITLE}. We are thrilled to have you as a registered member and hope that you find our service beneficial. Before we get you started please activate your account by clicking on the link below</p><p>{CONFIRMATION_LINK}</p><p>After your Account activation you will have  Post Ad, Chat with sellers and more. Once you have your Profile filled in you are ready to go.</p><p>Have further questions? You can find answers in our FAQ Section at {SITE_URL}contact</p><p>Sincerely,</p><p>{SITE_TITLE} Team!</p><p>{SITE_URL}</p>'),
('email_message_forgot_pass', '<p>To reset your password please click the link below</p><p>{FORGET_PASSWORD_LINK}</p><p>Have further questions? You can find answers in our FAQ Section at {SITE_URL}faq</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_contact', '<p>{NAME} wants to contact you </p><p>{SITE_TITLE}:</p><p>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {NAME}</p><p>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {EMAIL}</p><p>Message&nbsp; &nbsp; : {MESSAGE}</p><p>Questions? See our Knowledge-base and Support Center at {SITE_URL}faq</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_feedback', '<p>{NAME} Send a feedback </p><p>{SITE_TITLE}:</p><p>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {NAME}</p><p>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {EMAIL}</p><p>Phone&nbsp; &nbsp; &nbsp; &nbsp; : {PHONE}</p><p>Message&nbsp; &nbsp; : {MESSAGE}</p><p>Questions? See our Knowledge-base and Support Center at {SITE_URL}faq</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_report', '<p>The Following was sent automatically from  {SITE_TITLE}:</p><p>Name : {NAME}</p><p>Username : {USERNAME}</p><p>Email : {EMAIL}</p><p>Violation subject : {VIOLATION}</p><p>Violator username : {USERNAME2}</p><p>URL of violation: {URL}</p><p>Violation message : {DETAILS}</p><p><br></p><p>Questions? See our Knowledge-base and Support Center at {SITE_URL}faq</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_ad_approve', '<p>Congratulations! Your ad to {ADTITLE} on {SITE_TITLE} has been approved. You can view your item here: {ADLINK}</p><p>Thanks for your submission!</p><p>Regards,</p><p>{SITE_TITLE} Team </p><p>Questions? See our Knowledge-base and Support Center at {SITE_URL}faq</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_re_ad_approve', '<p>Congratulations! Your ad Re-Submission to {ADTITLE} on {SITE_TITLE} has been approved. You can view your item here: {ADLINK}</p><p>Thanks for your submission!</p><p>Regards,</p><p>{SITE_TITLE} Team</p><p>Questions? See our Knowledge base and Support Center at {SITE_URL}faq</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_contact_seller', '<p>{SENDER_NAME} wants to contact you.</p><p>Job Title&nbsp; : {ADTITLE}</p><p>Name&nbsp; &nbsp; &nbsp;: {SENDER_NAME}</p><p>Email&nbsp; &nbsp; : {SENDER_EMAIL}</p><p>Phone&nbsp; &nbsp; : {SENDER_PHONE}</p><p>Resume Link&nbsp; &nbsp;: {RESUME_LINK}</p><p>Sender Profile&nbsp; &nbsp; : {SENDER_PROFILE}</p><p>Message&nbsp; : {MESSAGE}</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}</p>'),
('email_message_post_notification', '<p>The following project was recently added to {SITE_TITLE} and fits under your expertise: {ADTITLE}<br></p><p>{ADLINK}</p><p>------------------------------------------------------------------------------------<br></p><p>This message has been sent automatically by the {SITE_TITLE} system.</p><p>If you need to contact us, go to {SITE_URL}contact</p><p>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_freelancer_project_awarded', '<p>{SITE_TITLE}</p><p>Hello,&nbsp;{FREELANCER_NAME}</p><p>{PROJECT_TITLE}&nbsp;Project awarded to you.</p><p>Go to this link&nbsp;{PROJECT_LINK} and accept.</p><p>You were chosen for the project named {PROJECT_TITLE} <br>Important: You must first accept (or deny) this offer by going to the following URL: {PROJECT_LINK} <br>If you wait too long another freelancer could be chosen! So accept the offer now.</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_freelancer_project_revoke', '<p>{SITE_TITLE}<br></p><p>The project {PROJECT_TITLE}&nbsp;has been revoked.</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_employer_project_accepted', '<p>{SITE_TITLE}</p><p>Hello,&nbsp;{EMPLOYER_NAME}</p><p></p><p>Project Accepted By Freelancer for&nbsp;{PROJECT_TITLE}</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_employer_project_approval_reject', '<p>{SITE_TITLE}</p><p>Hello,&nbsp;{EMPLOYER_NAME}</p><p> </p><p>Project Approval Rejected By Freelancer for&nbsp;{PROJECT_TITLE}</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_milestone_created', '<p>{SITE_TITLE}<br></p><p>A milestone created,</p><p>{MILESTONE_TITLE} payment of {MILESTONE_AMOUNT} for&nbsp;{PROJECT_TITLE}.</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_milestone_released', '<p>{SITE_TITLE}<br></p><p>A milestone released,</p><p>{MILESTONE_TITLE} payment of {MILESTONE_AMOUNT} for&nbsp;{PROJECT_TITLE}.</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_milestone_request_to_release', '<p>{SITE_TITLE}<br></p><p>You got a milestone release request,</p><p> {MILESTONE_TITLE} payment of {MILESTONE_AMOUNT} for&nbsp;{PROJECT_TITLE}.</p><p>------------------------------------<br><br>You can view this at&nbsp;{PROJECT_LINK}<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_withdraw_accepted', '<p>{SITE_TITLE}</p><p>Your withdrawal request accepted</p><p>amount :&nbsp;{AMOUNT}</p><p>------------------------------------<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_withdraw_rejected', '<p>{SITE_TITLE}</p><p>Your withdrawal request accepted</p><p>amount :&nbsp;{AMOUNT}</p><p>------------------------------------<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_withdraw_request', '<p>{SITE_TITLE}</p><p>Got a new withdrawal request</p><p>Amount :&nbsp;{AMOUNT}</p><p>------------------------------------<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),
('emailHTML_amount_deposit', '<p>{SITE_TITLE} - </p><p>A user deposit amount to wallet.</p><p>Amount :&nbsp;{AMOUNT}</p><p>------------------------------------<br><br>Do not reply to this email.<br><br>Regards<br>{SITE_TITLE}<br></p>'),    ('emailHTML_got_rating', '<p>{PROJECT_TITLE}</p><p><span><br></span></p><p><span>Rating: {RATING} stars</span><br><span>Comment:&nbsp;</span><span>{RATING_COMMENT}</span><br><br><span>------------------------------</span><span>------</span><br><br><span>You can view this at&nbsp;</span><font>{PROJECT_LINK}</font><br><br><span>Do not reply to this email.</span><br><br><span>Regards</span><font><br></font><font>{SITE_TITLE}</font><br></p>');
--
...
INSERT INTO `<<prefix>>payments` (`payment_install`, `payment_title`, `payment_folder`, `payment_desc`) VALUES
 ('1', 'Paypal', 'paypal', 'You will be redirected to paypal to complete payment.'),
 ('0', 'Stripe : Credit & Debit Card', 'stripe', 'Make an instant deposit using online payment service Stripe. Pay with your debit or credit card.'),
 ('0', 'Offline Payment', 'wire_transfer', NULL),
